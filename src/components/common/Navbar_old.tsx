...
const Navbar: React.FC<NavbarProps> = ({ onProfileClick }) => {
  ...
  return (
    <nav
      className={`
        navbar-fixed w-full transition-all duration-300 ease-out
        ${isScrolled 
        ...
        <div className="flex items-center h-16 justify-between transition-all duration-500 ease-out">
          ...
          <div className="flex items-center">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className={`${isScrolled ? 'text-lg' : 'text-2xl'} font-bold text-white transition-all duration-300`}>
                  PROJECT KEPLER
                </h1>
                <div className={`${isScrolled ? 'text-xs' : 'text-xs'} text-gray-400 font-mono`}>
